...
class ItemsStore {
    companion object {
        val globalItems = listOf(
            ...
            Item("2", "Harvey's Cookies", "Gives extra milk coins but halves your XP reward", 12, "placeholder_cookie"),
            Item("3", "Jasper's Hoodie", "Gives 10% more xp for all powerlifting moves done during a workout", 12, "placeholder_hoodie"),
            Item("4", "Anneme's Plumbob", "When equipped the plumbob multiplies all XP received by 2.4", 12, "placeholder_plumbob")
        )
    }
